...
# USB 设备信息    \~english USB device info
...
_MV_FRAME_OUT_INFO_EX_._fields_ = [
    ('nWidth',             c_ushort),                        # < \~chinese 图像宽(最大65535，超出请用nExtendWidth)
    ('nHeight',            c_ushort),                        # < \~chinese 图像高(最大65535，超出请用nExtendHeight)
    ...
    ('nFrameLenEx',         c_uint64),                         # < \~chinese 帧长度            \~english Reserved bytes
